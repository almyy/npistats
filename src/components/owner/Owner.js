...
import {
  OWNER_BY_OWNERID_QUERY,
  GAMES_BY_OWNERID_QUERY,
  PLAY_OFF_GAMES_BY_OWNERID_QUERY,
  REGULAR_SEASON_GAMES_BY_OWNERID_QUERY,
    ...
    <Fragment>
      <div className={classNames(style.title, "card")}>
        ...
        <nav className="card-nav">
          <NavLink to={`/owner/${ownerByOwnerId.id}/`} exact activeClassName="selected">
            {" "}
            All games{" "}
          </NavLink>
          <NavLink to={`/owner/${ownerByOwnerId.id}/regularSeason`} activeClassName="selected">
            {" "}
            Regular season{" "}
          </NavLink>
          <NavLink to={`/owner/${ownerByOwnerId.id}/playOff`} activeClassName="selected">
            {" "}
            Play Off{" "}
          </NavLink>
        </nav>
      ...
      <Route
        ...
        component={() => (
          <GameList
            games={games.gamesByOwnerId}
            loading={games.loading}
            ownerId={ownerByOwnerId.id}
          />
        )}
      />
      <Route
        path={`${match.path}/playOff`}
        exact
        component={() => (
          <GameList
            games={playOff.playOffGamesByOwnerId}
            loading={playOff.loading}
            ownerId={ownerByOwnerId.id}
          />
        )}
      />
      <Route
        path={`${match.path}/regularSeason`}
        exact
        component={() => (
          <GameList
            games={regularSeason.regularSeasonGamesByOwnerId}
            loading={regularSeason.loading}
            ownerId={ownerByOwnerId.id}
          />
        )}
      />
